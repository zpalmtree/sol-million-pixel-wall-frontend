      ...
      <main className="flex flex-col items-center justify-center flex-1 w-full mt-12">
        <div className="flex flex-col items-center space-y-4 text-center">
          <div className="space-y-2">
            ...
            <p className="max-w-[700px] text-[#EEEEEE] md:text-xl dark:text-[#EEEEEE]">
              Explore the world's largest NFT-powered pixel wall, where creativity and community collide on the Solana
              blockchain.
            </p>
          </div>
            ...
            <div className="flex flex-col justify-center space-y-4">
              <div className="space-y-2">
                ...
                <p className="max-w-[600px] text-[#EEEEEE] md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-[#EEEEEE]">
                  Mint your own sections of the million pixel wall and contribute to the ever-evolving Million Pixel Wall. Showcase
                  your talent as your creations gain popularity.
                </p>
              </div>
        ...
        <div className="flex flex-col items-center justify-center w-full px-4 md:px-6 py-12 md:py-24 lg:py-32 bg-[#1A1A1A] border-t border-[#C19A6B]">
          <div className="flex flex-col items-center justify-center space-y-3 w-full">
            ...
            <p className="max-w-[600px] text-[#EEEEEE] md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-[#EEEEEE]">
              Become a part of the vibrant community of pixel artists and collectors shaping the future of the Million
              Pixel Wall.
            </p>
            <a href='https://twitter.com/WallOnSolana'>
                <Button className="bg-[#C19A6B] text-[#1A1A1A]" type="submit">
                  Join us on Twitter
                </Button>
            </a>
          </div>
